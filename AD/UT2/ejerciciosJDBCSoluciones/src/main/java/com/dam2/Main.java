...
public class Main {
    public static void main(String[] args) {
        ...
        eps.insertarEmpleadoPrepared("Carlos", "Martinez", 32000, 1);
        eps.buscarEmpleadosPorDepartamento(1);

        // Probar batch insert
        List<Object[]> nuevosEmpleados = Arrays.asList(
                new Object[]{"Maria", "Lopez", 29000.0, 2},
                new Object[]{"Pedro", "Rodriguez", 31000.0, 1},
                new Object[]{"Laura", "Sanchez", 27000.0, 3}
        );
