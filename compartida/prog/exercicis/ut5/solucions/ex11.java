...
public class ex11
{
	public static void main(String[] args) 
	{
		...
		do{
		System.out.println("\n1.Alta\n2.Consultar pelicula\n3.Lllistar totes les películes\n4.Esborrar película\n0.Acabar");
		int n=ent.nextInt();
		switch(n)
		{
			case 1: alta();break;
	...
	public static void alta()
	{
			...
			)
		{
			...
			System.out.println("Escriu l'any de la película");
			any= ent.nextInt();
			dos.writeInt(cod);dos.writeUTF(titol);dos.writeUTF(director);dos.writeInt(any);
		}
		catch(IOException e)
		{
		...
		File f2 = new File("pelicules2.dat");
			try(FileInputStream fis = new FileInputStream("pelicules.dat");
				DataInputStream dis = new DataInputStream(fis);
				FileOutputStream fos = new FileOutputStream("pelicules2.txt");
			DataOutputStream dos= new DataOutputStream(fos))
			{
				cod=dis.readInt();
				titol=dis.readUTF(); director=dis.readUTF();
