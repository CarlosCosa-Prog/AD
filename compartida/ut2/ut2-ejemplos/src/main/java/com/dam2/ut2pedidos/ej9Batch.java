...
public class ej9Batch {
        ...
        try {
            ...
            String sql = "insert into clientes values(14,283445667,'electricidad martinez','jose martinez','pablo iglesias, 3')";
            stmt.addBatch(sql);
            sql = "insert into clientes values(15,383445667,'fontaneria perez','jose perez','pablo iglesias, 4')";
            stmt.addBatch(sql);
